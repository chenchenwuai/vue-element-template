<template>
  <transition name="viewer-fade">
    <div ref="el-image-viewer__wrapper" tabindex="-1" class="el-image-viewer__wrapper" :style="{ 'z-index': zIndex }">
      ...
      <!-- CANVAS -->
      <div class="el-image-viewer__canvas" @mousedown="handleMouseDown">
        <span v-if="loading"><i class="el-icon-loading" /><span style="font-size:13px;">加载中</span></span>
        <span v-if="loadError"><i class="el-icon-warning" /><span style="font-size:13px;">图片加载失败</span></span>
        <authImage
          ref="img"
          :url="currentImg"
